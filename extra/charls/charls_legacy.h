...
charls::jpegls_errc JpegLsEncodeStream(byte_stream_info destination, size_t &bytes_written, byte_stream_info source, const JlsParameters &params);
charls::jpegls_errc JpegLsDecodeStream(byte_stream_info destination, byte_stream_info source, const JlsParameters *params);
charls::jpegls_errc JpegLsReadHeaderStream(byte_stream_info source, JlsParameters *params);
