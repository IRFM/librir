...
namespace charls
{
    ...
    struct default_traits final
    {
        ...
        default_traits(const int32_t arg_maximum_sample_value, const int32_t arg_near_lossless, const int32_t reset = default_reset_value) noexcept : maximum_sample_value{arg_maximum_sample_value},
