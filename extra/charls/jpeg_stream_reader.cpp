...
namespace charls
{
    ...
    jpeg_stream_reader::jpeg_stream_reader(byte_stream_info byte_stream_info) noexcept : byte_stream_{byte_stream_info}
    {
    }
    ...
    int jpeg_stream_reader::try_read_spiff_header_segment(spiff_header &header, bool &spiff_header_found)
    {
        vector<char> source_tag;
