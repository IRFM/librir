...
namespace charls
{
    ...
    struct context_run_mode final
    {
        ...
        context_run_mode(const int32_t arg_run_interruption_type, const int32_t a, const int32_t reset_threshold) noexcept : run_interruption_type{arg_run_interruption_type},
                                                                                                                             a_{a},
