...
typedef struct charls_jpegls_encoder charls_jpegls_encoder;
	...
	charls_jpegls_decoder_read_spiff_header(IN_ charls_jpegls_decoder *decoder,
											...
											int32_t *header_found) CHARLS_NOEXCEPT CHARLS_ATTRIBUTE((nonnull));
	...
	charls_jpegls_decoder_get_frame_info(IN_ const charls_jpegls_decoder *decoder,
										 charls_frame_info *frame_info) CHARLS_NOEXCEPT CHARLS_ATTRIBUTE((nonnull));
	...
	charls_jpegls_decoder_get_preset_coding_parameters(IN_ const charls_jpegls_decoder *decoder,
													   int32_t reserved,
													   charls_jpegls_pc_parameters *preset_coding_parameters) CHARLS_NOEXCEPT CHARLS_ATTRIBUTE((nonnull));
	...
	charls_jpegls_encoder_get_estimated_destination_size(IN_ const charls_jpegls_encoder *encoder,
														 size_t *size_in_bytes) CHARLS_NOEXCEPT CHARLS_ATTRIBUTE((nonnull));
	...
	charls_jpegls_encoder_get_bytes_written(IN_ const charls_jpegls_encoder *encoder,
											size_t *bytes_written) CHARLS_NOEXCEPT CHARLS_ATTRIBUTE((nonnull));
...
namespace charls
{
	...
	public:
		...
		template <typename Container, typename ValueType = typename Container::value_type>
		CHARLS_NO_DISCARD Container decode(const uint32_t stride = 0) const
		{
	...
	public:
		...
		template <typename Container, typename ValueType = typename Container::value_type>
		static Container encode(const Container &source, const charls::frame_info &info, const charls::interleave_mode interleave_mode = charls::interleave_mode::none)
		{
