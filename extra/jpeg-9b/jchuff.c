    ...
    if (cinfo->Ss == 0 && cinfo->Ah == 0)
    {
      ...
      if (gather_statistics)
      {
        ...
        if (entropy->dc_count_ptrs[tbl] == NULL)
          entropy->dc_count_ptrs[tbl] = (long *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
                                                                           257 * SIZEOF(long));
    ...
    if (cinfo->Se)
    {
      ...
      if (gather_statistics)
      {
        ...
        if (entropy->ac_count_ptrs[tbl] == NULL)
          entropy->ac_count_ptrs[tbl] = (long *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
                                                                           257 * SIZEOF(long));
